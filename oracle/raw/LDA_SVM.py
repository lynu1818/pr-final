...
plt.title("Confusion Matrix: LDA + SVM")
plt.xlabel("Predicted")
plt.ylabel("True")
plt.tight_layout()
plt.savefig(os.path.join(output_dir, "confusion_matrix_lda_svm.png"))
plt.close()
...
df.to_csv(os.path.join(output_dir, "classification_report_lda_svm.csv"), index=False)
